    ...
    <div class="wrapper hold-transition skin-blue sidebar-mini">
      ...
      <header class="main-header">
        ...
        <a href="index.php" class="logo">
          ...
          <span class="logo-lg"><b>Teacher &nbsp;</b>My Office</span>
        </a>
            ...
            <div class="col-md-6" style="margin-top: 10%;">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Teacher Login :: My Office</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="teacher_auth.php">
                  <div class="box-body">
