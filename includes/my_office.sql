...
CREATE TABLE `t_cart` (
  ...
  `c_p_qty` int(11) UNSIGNED NOT NULL COMMENT 'Cart product quantity',
  `p_name` varchar(30) NOT NULL,
  `p_price` int(11) UNSIGNED NOT NULL COMMENT 'Price of one product',
   PRIMARY KEY (`c_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `t_cart` */

insert  into `t_cart`(`u_id`,  `s_id`, `p_id`,`c_p_qty`,`p_name`,`p_price`) values (1,1,1,5,'CHEEZ-IT',150);
...
CREATE TABLE `t_order_user_det` (
  ...
  `p_id` int(11) UNSIGNED NOT NULL,
  `p_name` varchar(30) NOT NULL,
  `p_amt` int(11) UNSIGNED NOT NULL,
  `b_id` int(11) UNSIGNED NOT NULL,
  `b_name` varchar(30) NOT NULL,
  `b_email` varchar(50) NOT NULL,
  `b_t_email` varchar(50) NOT NULL,
  `b_loc` varchar(30) NOT NULL,
  `s_id` int(11) UNSIGNED NOT NULL,
...
CREATE TABLE `t_product` (
  ...
  `s_t_email` varchar(50) NOT NULL,
  `p_name` varchar(30) NOT NULL,
  `p_qty` int(3) UNSIGNED NOT NULL,
  `p_img` varchar(255) NOT NULL,
  `p_wt` int(3) UNSIGNED NOT NULL COMMENT 'weight',
  `p_price` int(11) UNSIGNED NOT NULL,
  `p_desc` varchar(255) NOT NULL COMMENT 'Description',
  PRIMARY KEY (`p_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

/*Data for the table `t_product` */

insert  into `t_product`(`p_id`,`s_id`, `s_t_email`, `p_name`,`p_qty`,`p_img`,`p_wt`,`p_price`,`p_desc`) values (1,1, 'admin1@admin.com', 'CHEEZ-IT',0,'Product_Image/918CJVcvwPL.jpg',250,150,' Cheez-it  the real cheez'),(3,1, 'admin1@admin.com', 'Johnson Baby Shampoo',50,'Product_Image/best-sls-free-shampoo-in-india-4.jpg',150,200,' Baby Shampoo');
...
CREATE TABLE `t_supplier` (
  ...
  `s_loc` varchar(30) NOT NULL,
  `s_bal` int(11) UNSIGNED NOT NULL,
  PRIMARY KEY (`s_id`)
