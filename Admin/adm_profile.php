            ...
            <div class="tab-content">
              ...
              <!-- The profile Settings Form -->
                ...
                if(isset($_GET['adm_id']))
                {
                  ...
                  $adm_profile = $conn->prepare("SELECT * FROM t_admin WHERE a_mail= ?");
                  $admin_id->bind_param('s', $adm_id);
                  $adm_profile->execute();
                ...
                if (isset($_POST['adm_update']))
                {
                  ...
                  $adm_profile1 = $conn->prepare("SELECT * FROM t_admin WHERE a_mail= ?");
                  ...
                  if($adm_profile1->execute())
                  {
                    ...
                    if(password_verify($adm_pwd, $adm_row['a_pwd']))
                    {

                      $adm_update = $conn->prepare("UPDATE t_admin SET a_name = ?, a_loc = ?");
                ...
                <div class="tab-pane" id="pwd_setting">
                  ...
                  <?php 
                    ...
                    if (isset($_POST['adm_pwd_update']))
                    {
                      ...
                      if($adm_pwd1 === $adm_pwd2 && password_verify($adm_pwd0, $adm_profile1Row['a_pwd']))
                      {
         
                        $adm_update = $conn->prepare("UPDATE t_admin SET a_pwd = ? WHERE a_mail = ?");
